...
{
    /// <summary>
    /// Columns of this type must have a value, and are used to index the table. There must be
    /// precisely one <c>Key</c> column in any given table.
    /// </summary>
    Key,
    /// <summary>
    ...
    Normal,
    /// <summary>
    /// Columns of this type may have no value in a given row, which is represented as a <see
    /// langword="null"/> value in code.
    /// </summary>
    Nullable
}
/// <summary>
