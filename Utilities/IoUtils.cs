...
{
    /// <summary>
    /// If a given path is relative rather than absolute, returns an absolute path corresponding
    /// to that path relative to the <see cref="Paths.ImageFolder">default image folder</see>.
    /// </summary>
    /// <param name="path">A relative or absolute path.</param>
    /// <returns>
    /// An absolute path corresponding to the <c>relativePath</c> located within the default
    /// image folder.
    /// </returns>
    ...
    /// <summary>
    /// Loads an image at the specified <c>path</c>. If the <c>path</c> is relative, looks for
    /// the image in the <see cref="Paths.ImageFolder">default image folder</see>.
    /// </summary>
    ...
    /// <summary>
    /// Saves an image to the specified <c>path</c>. If the <c>path</c> is relative, saves it in
    /// the <see cref="Paths.ImageFolder">default image folder</see>.
    /// </summary>
