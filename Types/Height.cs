...
public class Height : IComparable
{
    ...
    private class Parser
    {
        ...
        /// <param name="result">
        /// The resultant <see cref="Height"/> if the parse attempt was successful, or <see
    ...
    /// </summary>
    /// <remarks>Calculated by averaging the amab and afab heights given <see href="https://ourworldindata.org/human-height#how-does-human-height-vary-across-the-world">here</see>.</remarks>
    ...
    /// </summary>
    /// <remarks>
    /// A <see cref="Height"/> equals another object if and only if the other object is of type
    /// <c>Height</c> and both <see cref="InCentimeters">InCentimeters</see> values match.
    /// </remarks>
    ...
    /// <summary>
    /// Gets the hash code for this <see cref="Height"/> object. Because equality is determined
    ...
    public int CompareTo(object? obj)
    {
        if (obj is null)
            return 1;
        if (obj is Height h)
            return InCentimeters.CompareTo(h.InCentimeters);
        if (obj is decimal d)
            return InCentimeters.CompareTo(d);
    ...
    /// <returns>
    /// <see langword="true"/> if the <c>Height</c> s are equal as described above, or <see
    /// langword="false"/> otherwise.
    /// </returns>
    ...
    /// <param name="b">The second <c>Height</c> to compare.</param>
    /// <returns>
    /// <see langword="true"/> if the <c>Height</c> s are unequal as described above, or <see
    /// langword="false"/> otherwise.
    /// </returns>
