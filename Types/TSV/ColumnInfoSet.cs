...
namespace grp
{
    ...
    public record ColumnInfoSet : IEnumerable<ColumnInfo>
    {
        ...
        /// <summary>
        /// Assembles a <c>ColumnInfoSet</c> from an arbitrary number of specified <see cref="ColumnInfo"/>s.
        /// Throws an <see cref="Exception"/> with some information if the column descriptors conflict, i.e.:
        /// <list type="bullet">
        ...
        /// </list>
        /// </summary>
        /// <param name="columnInfos">The <see cref="ColumnInfo"/>s from which to construct the set. Because of the <c>params</c> keyword,
        /// this does not need to be an explicitly constructed array.</param>
        /// <remarks>See the implicit conversion operators in <see cref="ColumnInfo"/>, which may make defining these more readable.</remarks>
        ...
        /// <param name="name">The <see cref="ColumnInfo.Name">Name</see> of the column whose info will be returned.</param>
        ...
        /// <param name="column">The <see cref="ColumnInfo.Name">Name</see> of the column whose <c>Key</c> status to check.</param>
        /// <returns><see langword="true"/> if the specified column is a <see cref="ColumnType.Key">Key</see> column, or <see langword="false"/> otherwise.</returns>
        public bool IsKey(string column) => this[column].IsKey;
        /// <param name="column">The <see cref="ColumnInfo.Name">Name</see> of the column whose nullability to check.</param>
        /// <returns><see langword="true"/> if the specified column <see cref="ColumnType.Nullable">may be null</see>, or <see langword="false"/> otherwise.</returns>
        ...
        /// and <see cref="ColumnType.Nullable">Nullable</see> columns have `❓` appended.
        /// </summary>
