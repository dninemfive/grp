...
namespace grp
{
    ...
    public record ColumnInfo
    {
        ...
        /// <summary>
        /// Implicitly converts a <c>(string, int)</c> tuple into a <c>ColumnInfo</c> with the string as its name and the int as its width.
        /// </summary>
        /// <param name="tuple"><c>(string, int)</c> where:
        /// <list type="bullet">
        ...
        /// <summary>
        /// Implicitly converts a <c>(string, int, <see cref="ColumnType"/>)</c> tuple into a <c>ColumnInfo</c> with the string as its name, the int as its width, 
        /// and the ColumnType as its type.
        /// </summary>
        /// <param name="tuple"><c>(string, int, <see cref="ColumnType"/>)</c> where:
        /// <list type="bullet">
        /// <item><c>name</c>: <inheritdoc cref="Name" path="/summary"/></item>
        /// <item><c>width</c>: <inheritdoc cref="Width" path="/summary"/></item>
