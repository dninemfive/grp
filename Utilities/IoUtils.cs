...
{
    /// <summary>
    /// If a given path is relative rather than absolute, returns an absolute path corresponding to
    /// that path relative to the <see cref="Paths.ImageFolder">default image folder</see>.
    /// </summary>
